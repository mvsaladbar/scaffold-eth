...
import "./ConvexDaiUsdcUsdtBase.sol";

/// @title ConvexDaiUsdcUsdt strategy used for cDai+cUsdc+cUsdt
/// @author Cosmin Grigore (@gcosmintech)
contract ConvexDaiUsdcUsdt is IStrategy, ConvexDaiUsdcUsdtBase {
    ...
    ICurveDaiUsdcUsdtLPGetter public lpGetter;
    ...
    constructor(
        ...
        lpGetter = ICurveDaiUsdcUsdtLPGetter(_curveLpGetter);
        ...
        onlyOwner
    {
        ...
        lpGetter = ICurveDaiUsdcUsdtLPGetter(_newAddr);
    }
