...
import "./CurveDaiUsdcUsdtPoolBase.sol";

/// @title CurveDaiUsdcUsdtPool strategy
/// @author Cosmin Grigore (@gcosmintech)
contract CurveDaiUsdcUsdtPool is IStrategy, CurveDaiUsdcUsdtPoolBase {
    ...
    constructor(
        ...
        lpVault = ICurveDaiUsdcUsdtLiquidityPool(_lpVault);
        lpGauge = ICurveDaiUsdcUsdtPoolGauge(_gauge);
        curveMinter = ICurveMinter(_minter);

        curveLPGetter = ICurveDaiUsdcUsdtLPGetter(_curveLpGetter);
        ...
        onlyOwner
    {
        ...
        lpGauge = ICurveDaiUsdcUsdtPoolGauge(_newAddr);
        rewardToken = lpGauge.crv_token();
    }
