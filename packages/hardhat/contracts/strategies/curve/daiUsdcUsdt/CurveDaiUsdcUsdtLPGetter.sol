...
import "../../../interfaces/curve/daiUsdcUsdt/ICurveDaiUsdcUsdtLiquidityPool.sol";
...
/// @title Convex LP getter contract
/// @author Cosmin Grigore (@gcosmintech)
contract CurveDaiUsdcUsdtLPGetter is
    ...
    ReentrancyGuard
{
    ...
    ICurveDaiUsdcUsdtLiquidityPool public override liquidityPool;
    ...
    constructor(address _curveLiquidityPool) {
        ...
        liquidityPool = ICurveDaiUsdcUsdtLiquidityPool(_curveLiquidityPool);
        tokenOut = liquidityPool.token();
    }
    ...
    function _removeLiquidity(
        ...
        OperationsLib.safeApprove(tokenOut, address(liquidityPool), _amount);

        uint256 assetBalanceBefore = IERC20(_token).balanceOf(address(this));
        liquidityPool.remove_liquidity_one_coin(_amount, _index, _min, false);
    ...
    function _addLiquidity(
        ...
        OperationsLib.safeApprove(_token, address(liquidityPool), _amount);
