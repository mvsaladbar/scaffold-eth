...
import "../../../interfaces/curve/daiUsdcUsdt/ICurveDaiUsdcUsdtPoolGauge.sol";
import "../../../interfaces/curve/daiUsdcUsdt/ICurveDaiUsdcUsdtLiquidityPool.sol";

/// @title CurveDaiUsdcUsdtPoolBase contract
/// @author Cosmin Grigore (@gcosmintech)
abstract contract CurveDaiUsdcUsdtPoolBase is CurveBase {
    /// @notice curve lp gauge
    ICurveDaiUsdcUsdtPoolGauge public lpGauge;
    /// @notice curve lp vault
    ICurveDaiUsdcUsdtLiquidityPool public lpVault;
    /// @notice custom contract for obtaining tokenIn
    ICurveDaiUsdcUsdtLPGetter public curveLPGetter;
        ...
        onlyOwner
    {
        ...
        lpVault = ICurveDaiUsdcUsdtLiquidityPool(_newAddr);
    }
        ...
        onlyOwner
    {
        ...
        curveLPGetter = ICurveDaiUsdcUsdtLPGetter(_newAddr);
    }
